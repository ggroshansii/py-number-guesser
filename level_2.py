...
def play_level_2():
    ...
    print("--")
    print(" ")
    print("Level 2 Description: In level two, the game is reversed and the user picks a number and the computer then has 3 guesses to select the correct answer.")
    print(" ")
    print("--")
    print(" ")
